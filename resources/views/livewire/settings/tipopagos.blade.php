<div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="float-right">
                    <button class="btn btn-primary btn-sm" data-placement="left" data-bs-toggle="modal"
                        data-bs-target="#modalTipoPagos" onclick="store()">
                ...
                <table class="table table-stripped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm e" title="Editar"
                                    wire:click="edit({{ $item->id }})" data-bs-toggle="modal"
                                    data-bs-target="#modalTipoPagos" onclick="update()">
    ...
    <!-- Modal -->
    <div wire:ignore class="modal fade" id="modalTipoPagos" tabindex="-1" aria-labelledby="modalTipoPagosLabel"
        aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTipoPagosLabel">Tipo de Pago</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 mb-2">
                            <input type="text" class="form-control" wire:model.defer="abreviatura" required>
                        </div>
                    </div>
