<div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="float-right">
                    <button class="btn btn-primary btn-sm" data-placement="left" data-bs-toggle="modal"
                        data-bs-target="#modalCargo" onclick="store()">
    ...
    <!-- Modal -->
    <div wire:ignore class="modal fade" id="modalCargo" tabindex="-1" aria-labelledby="modalCargoLabel"
        aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCargoLabel">CARGO DE EMPLEADO</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 mb-2">
                            {!! Form::select('area_id', $areas, $area_id,
                            ['class'=>'form-select','placeholder'=>'Seleccione un Area','wire:model'=>'area_id'])
                            !!}
                        </div>
                    </div>
