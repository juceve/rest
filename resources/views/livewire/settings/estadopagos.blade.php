<div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="float-right">
                    <button class="btn btn-primary btn-sm" data-placement="left" data-bs-toggle="modal"
                        data-bs-target="#modalEstadoPago" onclick="store()">
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm e" title="Editar" onclick="update()"
                                    ...
                                    data-bs-target="#modalEstadoPago">
    ...
    <!-- Modal -->
    <div wire:ignore class="modal fade" id="modalEstadoPago" tabindex="-1" aria-labelledby="modalEstadoPagoLabel"
